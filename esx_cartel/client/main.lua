...
local props = {
    ...
    SetVehicleCustomSecondaryColour(vehicle, 0, 1, 2),
...
local blips = {
  ...
  {title="~p~cartel", colour=83, id=84, x = 70.59, y = -1911.92, z = 20.8}
  }
  Citizen.CreateThread(function()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_cartel:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
  ...
  ESX.TriggerServerCallback('esx_cartel:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_cartel:buy', function(hasEnoughMoney)
...
AddEventHandler('esx_cartel:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job2 ~= nil and PlayerData.job2.name == 'cartel' and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'cartel' then
      ...
      for k,v in pairs(Config.GangStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.name == 'cartel' and PlayerData.job2.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'cartel' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'cartel' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'cartel_actions') and (GetGameTimer() - GUI.Time) > 150 then
