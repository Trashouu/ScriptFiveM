...
RegisterServerEvent('esx_cartel:confiscatePlayerItem')
AddEventHandler('esx_cartel:confiscatePlayerItem', function(target, itemType, itemName, amount)
...
ESX.RegisterServerCallback('esx_cartel:getFineList', function(source, cb, category)
  ...
  MySQL.Async.fetchAll(
    'SELECT * FROM fine_types_cartel WHERE category = @category',
    {
      ['@category'] = category
    },
    function(fines)
...
ESX.RegisterServerCallback('esx_cartel:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_cartel:removeArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_cartel:buy', function(source, cb, amount)
